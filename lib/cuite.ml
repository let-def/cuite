...
module QAbstractItemModel = struct
  ...
  external data : [> qAbstractItemModel] Qt.t -> [> qModelIndex] Qt.t -> qt'ItemDataRole -> QVariant.t = "mlqt_QAbstractItemModel_data"
  external setData : [> qAbstractItemModel] Qt.t -> [> qModelIndex] Qt.t -> QVariant.t -> qt'ItemDataRole -> bool = "mlqt_QAbstractItemModel_setData"
  external headerData : [> qAbstractItemModel] Qt.t -> int -> qt'Orientation -> qt'ItemDataRole -> QVariant.t = "mlqt_QAbstractItemModel_headerData"
  external setHeaderData : [> qAbstractItemModel] Qt.t -> int -> qt'Orientation -> QVariant.t -> qt'ItemDataRole -> bool = "mlqt_QAbstractItemModel_setHeaderData"
