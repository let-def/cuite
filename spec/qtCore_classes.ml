...
let qModelIndex = qstruct "QModelIndex"
...
let qOperatingSystemVersion = qclass ~version:(5,9,0) "QOperatingSystemVersion"
...
let qItemSelectionRange = qstruct "QItemSelectionRange"
...
let qDeadlineTimer = qclass ~version:(9,9,9) "QDeadlineTimer"
