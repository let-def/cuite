...
let qModelIndex = qclass "QModelIndex"
...
let qFileInfo = qclass "QFileInfo"
...
let qByteArray = qclass "QByteArray"
...
let qRegularExpressionMatch = qclass "QRegularExpressionMatch"
let qRegExp = qclass "QRegExp"
...
let qStringRef = qclass "QStringRef"
...
let qRegularExpression = qclass "QRegularExpression"
...
let qDir = qclass "QDir"
let qMultiMap = qclass "QMultiMap" ~extend:qMap
let qUnhandledException = qclass "QUnhandledException" ~extend:qException
let qItemSelection = qclass "QItemSelection"
let qByteArrayList = qclass "QByteArrayList" (*~extend:qList*)
