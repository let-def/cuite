...
let qTextBlock = qstruct "QTextBlock" ~modifier:`Const_ref
let qTextOption = qclass "QTextOption"
let qRgba64 = qclass "QRgba64"
let qQuaternion = qstruct "QQuaternion" ~modifier:`Const_ref
let qMatrix = qstruct "QMatrix" ~modifier:`Const_ref
...
let qTextCursor = qstruct "QTextCursor" ~modifier:`Const_ref
let qVector4D = qstruct "QVector4D" ~modifier:`Const_ref
...
let qIcon = qstruct "QIcon" ~modifier:`Const_ref
...
let qPalette = qstruct "QPalette" ~modifier:`Const_ref
...
let qTextFormat = qstruct "QTextFormat" ~modifier:`Const_ref
let qColor = qstruct "QColor" ~modifier:`Const_ref
let qMatrix4x4 = qstruct "QMatrix4x4" ~modifier:`Const_ref
let qAccessible = qclass "QAccessible"
let qPixmapCache = qclass "QPixmapCache"
let qVector2D = qstruct "QVector2D" ~modifier:`Const_ref
...
let qBrush = qstruct "QBrush" ~modifier:`Const_ref
...
let qFont = qstruct "QFont" ~modifier:`Const_ref
let qPointingDeviceUniqueId = qclass "QPointingDeviceUniqueId"
let qOpenGLVersionProfile = qclass "QOpenGLVersionProfile"
let qPen = qstruct "QPen" ~modifier:`Const_ref
let qVector3D = qstruct "QVector3D" ~modifier:`Const_ref
let qKeySequence = qstruct "QKeySequence" ~modifier:`Const_ref
